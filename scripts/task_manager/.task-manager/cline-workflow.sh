...
echo -e "${BLUE}Step 3: Creating task file in docs/tasks directory...${NC}"
mkdir -p "$PROJECT_ROOT/docs/tasks"

cat > "$PROJECT_ROOT/docs/tasks/$TASK_FILENAME" << EOF
# New Cline Task - $(date)
